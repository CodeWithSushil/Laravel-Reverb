<div>
    <div style="overscroll-behavior: none;">
      <div
        class="fixed w-full bg-sky-400 h-16 pt-2 text-white flex justify-between shadow-md"
      ...
      <div class="mt-20 mb-16">
        ...
        <div class="clearfix">
          <div
            class="bg-sky-300 float-right w-3/4 mx-4 my-2 p-2 rounded-lg clearfix"
    ...
    <div class="fixed w-full flex justify-between bg-sky-100" style="bottom: 0px;">
      <textarea
